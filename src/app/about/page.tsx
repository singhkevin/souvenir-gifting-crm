...
export const metadata: Metadata = {
  title: 'About',
  description: 'Gifting Solutions is a corporate gifting CRM and catalogue, from enquiry through fulfilment.',
}
    ...
    <SiteShell>
      <div className="border-b border-[#E8E4DE] bg-[#F6F4F1]">
        <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
          ...
          <h1 className="store-section-title mt-3">Welcome to Gifting Solutions.</h1>
      ...
      <div className="mx-auto max-w-3xl space-y-6 px-4 py-12 text-base leading-relaxed text-[#5C6570] sm:px-6 lg:px-8">
        <p>
          Gifting Solutions is a corporate gifting CRM and product catalogue. Teams use it to select gifts, prepare quotations,
          manage orders and follow the work through fulfilment and invoicing.
        </p>
        <p>
          This public collection is the same catalogue the Gifting Solutions team maintains — not a second store, and not a
