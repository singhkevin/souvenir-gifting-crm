        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm space-y-4">
          ...
          <form action={handleUpdate} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                <span className="mb-1 block text-xs font-semibold text-gray-700 hidden md:block">Status</span>
                <MobileSheetSelect
                  name="status"
                  label="Status"
                  ...
                  desktopClassName="w-full px-3 py-2 text-xs border border-gray-200 rounded-lg bg-white"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <span className="mb-1 block text-xs font-semibold text-gray-700 hidden md:block">Category *</span>
                <MobileSheetSelect
                  name="category_id"
                  label="Category"
              ...
              <div>
                <span className="mb-1 block text-xs font-semibold text-gray-700 hidden md:block">Brand</span>
                <MobileSheetSelect
                  name="brand_id"
                  label="Brand"
            ...
            <div>
              <span className="mb-1 block text-xs font-semibold text-gray-700 hidden md:block">Supplier</span>
              <MobileSheetSelect
                name="supplier_id"
                label="Supplier"
